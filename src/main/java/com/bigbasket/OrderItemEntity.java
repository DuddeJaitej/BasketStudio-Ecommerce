...
public class OrderItemEntity {
    ...
    public OrderItemEntity(OrderEntity order, ProductEntity product, int quantity, int unitPrice) { this.order=order; this.product=product; this.quantity=quantity; this.unitPrice=unitPrice; }
